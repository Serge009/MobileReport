    ...
    if (filter_type == 4) {
        ...
        for (var i in filter_items) {
            if (filter.id == filter_items[i].graph_filter
                ...
                res += '<div class="filter-table" data-value="' + filter_items[i].list_value + '" data-filter="' +
                        filter.id + '" data-var-name="' + filter.var_name + '">' +
                        '<div><h4>' + filter.name + '</h4></div>' +
                        '<div><h4>' + filter_items[i].display_value + '</h4></div>' +
                        '</div>';
            }
        }
